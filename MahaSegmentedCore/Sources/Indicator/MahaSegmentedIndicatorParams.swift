//
//  MahaSegmentedIndicatorParamsModel.swift
//  MahaSegmentedView
//
 ...
 */
public struct MahaSegmentedIndicatorSelectedParams {
    public let currentSelectedIndex: Int
    public let currentSelectedItemFrame: CGRect
    public let selectedType: MahaSegmentedViewItemSelectedType
    public let currentItemContentWidth: CGFloat
    /// collectionView的contentSize
    public var collectionViewContentSize: CGSize?

    public init(currentSelectedIndex: Int, currentSelectedItemFrame: CGRect, selectedType: MahaSegmentedViewItemSelectedType, currentItemContentWidth: CGFloat, collectionViewContentSize: CGSize?) {
...
public struct MahaSegmentedIndicatorTransitionParams {
    public let currentSelectedIndex: Int
