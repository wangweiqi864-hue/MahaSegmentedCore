//
//  MahaSegmentedIndicatorProtocol.swift
//  MahaSegmentedView
//
...
public protocol MahaSegmentedIndicatorProtocol: UIView {
    ...
    func refreshIndicatorState(model: MahaSegmentedIndicatorSelectedParams)
    ...
    /// param percent 过渡百分比
    /// - Parameter model: model description
    func contentScrollViewDidScroll(model: MahaSegmentedIndicatorTransitionParams)
    ...
    /// - Parameter model: model description
    func selectItem(model: MahaSegmentedIndicatorSelectedParams)
}
