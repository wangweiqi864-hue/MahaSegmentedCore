...
public protocol MahaSegmentedViewRTLCompatible: class {
    func segmentedViewShouldRTLLayout() -> Bool
    func segmentedView(horizontalFlipForView view: UIView?)
}

public extension MahaSegmentedViewRTLCompatible {
...
class MahaSegmentedRTLCollectionCell: UICollectionViewCell, MahaSegmentedViewRTLCompatible {
