//
//  MahaSegmentedTitleAttributeDataSource.swift
//  MahaSegmentedView
//
...
open class MahaSegmentedTitleAttributeDataSource: MahaSegmentedBaseDataSource {
    /// 富文本title数组
    ...
    open override func preferredItemModelInstance() -> MahaSegmentedBaseItemModel {
        return MahaSegmentedTitleAttributeItemModel()
    }
    ...
    open override func registerCellClass(in segmentedView: MahaSegmentedView) {
        segmentedView.collectionView.register(MahaSegmentedTitleAttributeCell.self, forCellWithReuseIdentifier: "cell")
    }
