...
#ifndef MAHASEGMENTEDCORE_SWIFT_H
#define MAHASEGMENTEDCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MahaSegmentedCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP17MahaSegmentedCore40MahaSegmentedListContainerViewDataSource_")
@protocol MahaSegmentedListContainerViewDataSource
@end

SWIFT_PROTOCOL("_TtP17MahaSegmentedCore42MahaSegmentedListContainerViewListDelegate_")
@protocol MahaSegmentedListContainerViewListDelegate
@optional
- (void)listWillAppear;
- (void)listDidAppear;
